...
function PostFormEdit() {
  ...
  const hdlUpdatePost = async () => {
    try {
      ...
      if (removepic) {
        body.append('removePic', removepic)
      }
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex justify-between border rounded-lg p-2 items-center">
        ...
        <div className="flex justify-center items-center w-10 h-10 cursor-pointer rounded-full bg-slate-100
